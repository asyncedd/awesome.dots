...
local mocha = require("themes.async.colors.catppuccin.mocha")
...
theme.bg_minimize = mocha.surface0
theme.bg_systray = theme.bg_normal

local lighter_lavender = color.lighten(mocha.lavender, 0.8, mocha.base)
